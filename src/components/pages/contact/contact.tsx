        ...
        <form method="POST" onSubmit={handleSubmit}>
          <div className=" grid gap-5 lg:gap-8">
            ...
            {/* <input
              ...
              onChange={handleChange}
              className="px-3 py-2 rounded-lg outline-none border-b-2 border-[#00B7AB] focus:border-[#1F2259] hover:border-[#1F2259] focus-visible:border-[#1F2259]"
              max="9999-12-31" // Set the maximum year to 9999
              required
            /> */}
      ...
      <div className="grid md:grid-cols-3 gap-4 justify-between mt-20 divide-x-1 text-lg">
        <div className="flex items-center gap-3 px-5 justiy-center">
          <Image
            ...
            height={28}
          />
          {/* src="images/phone-number.webp" width={28} className="" alt="" /> */}
          <a href="tel:+918929062906" className="text-lg">
            +91 89290 62906
          </a>
        </div>
        <div className="flex items-center gap-3 px-5 md:justify-center">
          <Image
            ...
            alt=""
          />
          <a href="mailto:Info@Drpathcares.com" className="text-lg">
