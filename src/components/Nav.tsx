          ...
          <div className="parent w-full">
            <div className="one hidden lg:grid bg-[#00B7AB] justify-end pr-4 xl:pr-8 gap-6">
              <div className="py-4 flex items-center text-white gap-6">
                ...
                <a
                  href=""
                  type="button"
                  className="flex gap-2 items-center bg-white py-2 px-4 rounded-lg shadow text-[#00B7AB]"
                >
                  <Image
                ...
                <a
                  href=" https://wa.me/9125393939"
                  type="button"
                  className="flex gap-2 items-center bg-white py-2 px-4 rounded-lg text-[#00B7AB] shadow"
                >
                  <Image
            ...
            <div className="two flex items-center py-4 gap-6 xl:gap-12 justify-end pr-6 xl:pr-20">
              <nav>
                ...
                <div
                  className={`w-full md:block md:w-auto duration-100 ease-in-out transition-all ${isNavMenuVisible ? "block" : "hidden"}`}
                  id="navbar-default"
                >
              ...
              <a
                href="/test"
                type="button"
                className="lg:flex hidden gap-2 items-center bg-white py-2 px-4 rounded-lg text-[#00B7AB] shadow shadow-gray-300"
              >
                <Image
